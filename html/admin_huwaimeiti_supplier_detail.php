...
<!--			</form>			-->
			...
			<div class="main_o clearfix" style="padding-bottom:20px;width:90%;border:none;box-shadow: 0px 0px 0px #fff;">
				...
				<div class="clearfix" style="padding-top:50px;">
					...
					<div class="item_f"><p><i class="LGntas"></i>投放媒体优势：</p>
						<div class="r">
							<textarea class="txt_ft1" style="width:70%;height:128px;"></textarea>
						</div>
					</div>

					<div class="item_f"><p><i class="LGntas"></i>投放媒体基料：</p>
						<div class="r">
<ul class="ul_table clearfix">
	<li><span class="sp1">刊例价：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="200元" /></span>
	</li>
	...
	<li><span class="sp1">媒体规格：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="19.2m*10.97m 1面" /></span>
	</li>
	...
	<li><span class="sp1">媒体面积：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="200平方" /></span>
	</li>
					...
					<div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul class="sortable" category_id="0" set_name="network">
								<li data_id="0"><a class="cur" href="">全部</a></li>
