		...
		<div class="clearfix wrap_f" style="padding-bottom:50px;">
			...
			<form action="" method="post">
				...
				<div class="item_f txt_table"><p><i class="LGntas"></i>投放基数：</p>
					<div class="r">
						<ul>
							<li><span class="sp1">投放形式：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">广告商圈：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放周期：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放面积：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放位置：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放形式：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">广告商圈：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放周期：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
							<li><span class="sp1">投放面积：</span><input type="text" name="textfield" id="textfield" class="txt_f1" /></li>
				...
				<div class="item_f"><p><i class="LGntas"></i>订单内容：</p>
					<div class="r">
						<textarea class="txt_ft1" style="height:230px;border-radius:10px;"></textarea>
					</div>
				</div>
				...
				<div class="item_f"><p><i class="LGntas"></i>平台价备注：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:97%;" /></div>
				</div>
				...
				<div class="item_f"><p><i class="LGntas"></i>确认订单：</p>
					<div class="r">
						<select id="querendingdan" class="sel_f1" style="float:left;margin-right:8px;">
							...
							<option value="finish">确认完成</option>
							<option value="3">......</option>
						</select>
